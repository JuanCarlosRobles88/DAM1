...
public class Juego {
    ...
    public Movimiento dameMovimiento(String jugada, Tablero tabla) {
        ...
        if (jugada.equalsIgnoreCase("FIN")) {
            ...
            //if ((jugadaChar[0]< 65 || jugadaChar[0]>72)||(jugadaChar[2]<65 || jugadaChar[2]>72)||(jugadaChar[1]< 49 || jugadaChar[1]>56)||(jugadaChar[3]< 49 || jugadaChar[3]>56)) //hay que chequear errores relativos al turno y al color de las piezas
